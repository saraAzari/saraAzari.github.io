...
Confluence.Templates.Labels.dialogLabels = function(opt_data, opt_ignored) {
  ...
  for (var labelIndex18 = 0; labelIndex18 < labelListLen18; labelIndex18++) {
    ...
    output += '<li class="aui-label ' + ((opt_data.editable) ? 'aui-label-closeable aui-label-split' : '') + '" data-label-id="' + soy.$$escapeHtml(labelData18.id) + '"><a class="aui-label-split-main" href="' + soy.$$escapeHtml("/confluence") + soy.$$escapeHtml(labelData18.link) + '" rel="tag">' + ((! labelData18.prefix || labelData18.prefix == 'global' || labelData18.prefix == 'team') ? soy.$$escapeHtml(labelData18.name) : soy.$$escapeHtml(labelData18.prefix) + ':' + soy.$$escapeHtml(labelData18.name)) + '</a>' + ((opt_data.editable) ? '<span class="aui-label-split-close"><span tabindex="0" class="aui-icon aui-icon-close"  title="' + soy.$$escapeHtml('Delete Label') + '" original-title="' + soy.$$escapeHtml('Delete Label') + '">' + soy.$$escapeHtml('Delete Label') + '</span></span>' : '') + '</li>';
  }
  return output;
};
if (goog.DEBUG) {
